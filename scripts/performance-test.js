...
const DEFAULTS = {
	base:
		process.env.MOMOI_BASE_URL ||
		`http://localhost:${process.env.MOMOI_PORT || 3001}`,
...
async function main() {
	...
	console.log(
		`Duration: ${args.durationSec}s  Concurrency: ${args.concurrency} per path  Method: ${args.method}`,
	);
