...
import { CreateExtendedRequestResponse, CreateRequestResponse } from "@momoi/model/request";
 ...
 */
export function mapRequest(request: RequestResult): Static<typeof CreateRequestResponse> {
    return {
        id: request.id,
        title: request.title,
 ...
 */
export function mapExtendedRequest(extendedRequest: ExtendedRequestResult): Static<typeof CreateExtendedRequestResponse> {
    return {
        ...
        courseOffering: mapCourseOffering(extendedRequest.targetInstance?.courseOffering ?? null),
