...
export class QueueModule {
	public provisionInstanceQueue: Queue<
		ProvisionInstanceJobData,
		ProvisionInstanceJobResult
	>;
	public deprovisionInstanceQueue: Queue<
		DeprovisionInstanceJobData,
		DeprovisionInstanceJobResult
	>;
	public toggleInstanceStatusQueue: Queue<
		ToggleInstanceStatusJobData,
		ToggleInstanceStatusJobResult
	>;
	...
	constructor(base_key: string = env.NODE_ENV) {
		...
		// Initialize queues
		this.provisionInstanceQueue = new Queue<
			ProvisionInstanceJobData,
			ProvisionInstanceJobResult,
			string,
			ProvisionInstanceJobData,
		...
		this.deprovisionInstanceQueue = new Queue<
			DeprovisionInstanceJobData,
			DeprovisionInstanceJobResult,
			string,
			DeprovisionInstanceJobData,
		...
		this.toggleInstanceStatusQueue = new Queue<
			ToggleInstanceStatusJobData,
			ToggleInstanceStatusJobResult,
			string,
			ToggleInstanceStatusJobData,
