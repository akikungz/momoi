...
describe("Autocomplete Route", () => {
  ...
  describe("GET /autocomplete/courses", () => {
    it("should return course options", async () => {
      const client = treaty(autocompleteRoute(mockPrisma, mockAdminAuth));
  ...
  describe("Authentication", () => {
    it("should return 401 for unauthenticated user", async () => {
      const client = treaty(autocompleteRoute(mockPrisma, mockOtherAuth));
    ...
    it("should allow student access to autocomplete", async () => {
      const client = treaty(autocompleteRoute(mockPrisma, mockStudentAuth));
