...
export const storageModel = new Elysia({ name: "storage.model" })
  ...
  .model("CreateStorageFileVersionRequestBody", CreateStorageFileVersionRequestBody)
  ...
  .model("CreateStorageFilePermissionRequestBody", CreateStorageFilePermissionRequestBody)
  .model("UpdateStorageFilePermissionRequestBody", UpdateStorageFilePermissionRequestBody);
