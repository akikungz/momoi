...
import { ObjectStorageProvider } from "@momoi/storage-provider";
...
export const storageRoute = (
  ...
  .use(storageModel)
  .guard({ auth: true })
  .decorate("storageService", new StorageService(prisma, cache, objectStorage))

  .group("/files", (app) => app
    .get("/", async ({ storageService, user, query }) => {
      return storageService.getFiles(user, query);
    }, {
    ...
    .get("/search", async ({ storageService, user, query }) => {
      return storageService.searchFiles(user, query);
    }, {
    ...
    .post("/", async ({ storageService, user, body }) => {
      return storageService.createFile(user, body);
    }, {
    ...
    .post("/upload-url", async ({ storageService, user, body }) => {
      return storageService.createUploadUrl(user, body);
    }, {
    ...
    .get("/:fileId", async ({ storageService, user, params }) => {
      return storageService.getFileDetail(user, params.fileId);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .get("/:fileId/download-url", async ({ storageService, user, params }) => {
      return storageService.createDownloadUrl(user, params.fileId);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .patch("/:fileId", async ({ storageService, user, params, body }) => {
      return storageService.updateFile(user, params.fileId, body);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .delete("/:fileId", async ({ storageService, user, params }) => {
      return storageService.deleteFile(user, params.fileId);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .post("/:fileId/move", async ({ storageService, user, params, body }) => {
      return storageService.moveFile(user, params.fileId, body.parentId);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .post("/:fileId/copy", async ({ storageService, user, params, body }) => {
      return storageService.copyFile(user, params.fileId, body);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .get("/:fileId/versions", async ({ storageService, user, params }) => {
      return storageService.getVersions(user, params.fileId);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .post("/:fileId/upload-url", async ({ storageService, user, params, body }) => {
      return storageService.createVersionUploadUrl(user, params.fileId, body);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .post("/:fileId/versions", async ({ storageService, user, params, body }) => {
      return storageService.createVersion(user, params.fileId, body);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .get("/:fileId/versions/:versionId/download-url", async ({ storageService, user, params }) => {
      return storageService.createVersionDownloadUrl(user, params.fileId, params.versionId);
    }, {
      params: t.Object({
        fileId: t.String(),
        versionId: t.Number(),
    ...
    .delete("/:fileId/versions/:versionId", async ({ storageService, user, params }) => {
      return storageService.deleteVersion(user, params.fileId, params.versionId);
    }, {
      params: t.Object({
        fileId: t.String(),
        versionId: t.Number(),
    ...
    .get("/:fileId/permissions", async ({ storageService, user, params }) => {
      return storageService.getPermissions(user, params.fileId);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .post("/:fileId/permissions", async ({ storageService, user, params, body }) => {
      return storageService.createPermission(user, params.fileId, body);
    }, {
      params: t.Object({
        fileId: t.String(),
      }),
    ...
    .patch("/:fileId/permissions/:permissionId", async ({ storageService, user, params, body }) => {
      return storageService.updatePermission(user, params.fileId, params.permissionId, body);
    }, {
      params: t.Object({
        fileId: t.String(),
    ...
    .delete("/:fileId/permissions/:permissionId", async ({ storageService, user, params }) => {
      return storageService.deletePermission(user, params.fileId, params.permissionId);
    }, {
      params: t.Object({
        fileId: t.String(),
        permissionId: t.Number(),
