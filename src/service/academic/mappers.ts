 ...
 */
export function mapMailingListEntry(entry: MailingListSelectResult): MailingListEntry {
    return {
        id: entry.id,
        email: entry.email,
 ...
 */
export function mapCourseDetail(course: CourseWithRelations): CourseDetailResponse {
    return {
        id: course.id,
        code: course.code,
        title: course.title,
