...
export const InstructorMailingListValue = t.Object(
  {
    id: t.Number({ description: "Unique identifier for the mailing list value" }),
    email: t.String({ format: "email", description: "Email address of the instructor" }),
...
export const InstructorValue = t.Object(
  {
    id: t.Number({ description: "Unique identifier for the instructor listing" }),
...
export const CourseValue = t.Object(
  {
    ...
    isActive: t.Boolean({ description: "Indicates if the course is currently active" }),
    ...TimestampResponse.properties,
  },
...
export const SemesterValue = t.Object(
  {
    ...
    isCurrent: t.Boolean({ description: "Indicates if this semester is the current active semester" }),
    ...TimestampResponse.properties,
  },
...
export const InstructorMailingListByIdRequestParams = t.Object(
  {
    mailingId: t.Number({ description: "Unique identifier for the mailing list entry" }),
  },
...
export const RemoveInstructorMailingListResponse = t.Object(
  {
    success: t.Boolean({ description: "Indicates if the removal was successful" }),
  },
...
export const GetInstructorByIdResponse = t.Object(
  {
    ...
    courses: t.Array(CourseValue, { description: "List of courses taught by the instructor" }),
    ...TimestampResponse.properties,
  },
...
export const DeleteInstructorByIdResponse = t.Object(
  {
    success: t.Boolean({ description: "Indicates if the deletion was successful" }),
  },
...
export const GetCourseByIdResponse = t.Object(
  {
    ...
    isActive: t.Boolean({ description: "Indicates if the course is currently active" }),
    instructors: t.Array(InstructorValue, { description: "List of instructors teaching the course" }),
    semesters: t.Array(SemesterValue, { description: "List of semesters when the course is offered" }),
    ...TimestampResponse.properties,
  },
...
export const AddCourseResponse = t.Object(
  CourseValue.properties,
...
export const EditCourseByIdRequestBody = t.Object(
  {
    code: t.Optional(
      t.String({ description: "Course code" })
    ),
    title: t.Optional(
      t.String({ description: "Title of the course" })
    ),
    description: t.Optional(
      t.String({ description: "Description of the course" })
    ),
...
export const GetCurrentSemesterResponse = t.Union(
  [
    SemesterValue,
    t.Null(),
  ],
...
export const AddSemesterResponse = t.Object(
  SemesterValue.properties,
...
export const EditSemesterByIdRequestBody = t.Object(
  {
    name: t.Optional(
      t.String({ description: "Name of the semester" })
    ),
    startDate: t.Optional(
      t.Date({ description: "Start date of the semester" })
    ),
    endDate: t.Optional(
      t.Date({ description: "End date of the semester" })
    ),
    isCurrent: t.Optional(
      t.Boolean({ description: "Indicates if this semester is the current active semester" })
    ),
  },
  { description: "Request body for editing semester details" }
);

export const EditSemesterByIdResponse = t.Object(
  SemesterValue.properties,
...
export const academicModel = new Elysia({ name: "academic.model" })
  ...
  .model("InstructorMailingListByIdRequestParams", InstructorMailingListByIdRequestParams)
  .model("AddInstructorMailingListRequestBody", AddInstructorMailingListRequestBody)
  .model("AddInstructorMailingListResponse", AddInstructorMailingListResponse)
  .model("RemoveInstructorMailingListResponse", RemoveInstructorMailingListResponse)
