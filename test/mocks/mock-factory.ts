...
import type {
	...
	PVEVMStatus,
	PVEVMType,
	InstanceProvisionStatus,
	PlatformFileType,
	PlatformFileViewerRole,
	PlatformFileVisibility,
} from "@momoi/database/prisma/generated/enums";
 ...
 */
export function createMockCourseOffering(
 ...
 */
export function createMockPVETemplate(
	overrides?: Partial<PVETemplate>,
): PVETemplate {
 ...
 */
export function createMockPlatformFile(
	overrides?: Partial<PlatformFile>,
): PlatformFile {
 ...
 */
export function createMockPlatformFolder(
	overrides?: Partial<PlatformFile>,
): PlatformFile {
 ...
 */
export function createMockPlatformFileVersion(
	overrides?: Partial<PlatformFileVersion>,
): PlatformFileVersion {
 ...
 */
export function createMockPlatformFilePermission(
	overrides?: Partial<PlatformFilePermission>,
): PlatformFilePermission {
