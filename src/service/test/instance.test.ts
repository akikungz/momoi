...
describe("InstanceService", () => {
  ...
  describe("createInstance", () => {
    it("should create an instance with provided data", async () => {
      ...
      const result = await instanceService.createInstanceByInstructor(userId, createBody);
    ...
    it("should throw error on unexpected error", async () => {
      ...
      mockPrisma.instance.create.mockRejectedValueOnce(new Error("Unexpected error"));
  ...
  describe("getInstancesByInstructor", () => {
    it("should retrieve instances for instructor's courses with pagination", async () => {
      ...
      const result = await instanceService.getInstancesByInstructor(instructorId, query);
