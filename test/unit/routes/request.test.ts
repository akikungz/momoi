...
describe("Request Route", () => {
  ...
  it("student can create request", async () => {
    const client = treaty(requestRoute(mockPrisma, mockCache as any, mockStudentAuth, mockQueue as any));
  ...
  it("instructor can approve request for their course", async () => {
    const client = treaty(requestRoute(mockPrisma, mockCache as any, mockInstructorAuth, mockQueue as any));
  ...
  it("admin can approve any request", async () => {
    const client = treaty(requestRoute(mockPrisma, mockCache as any, mockAdminAuth, mockQueue as any));
