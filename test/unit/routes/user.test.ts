...
describe("User Route - Admin", () => {
	...
	it("should get user profile", async () => {
		const client = treaty(
			userRoute(mockPrisma, mockCache as any, mockAdminAuth),
		);
...
describe("User Route - Instructor", () => {
	...
	it("should get user profile", async () => {
		const client = treaty(
			userRoute(mockPrisma, mockCache as any, mockInstructorAuth),
		);
		const response = await client.user.me.get();
...
describe("User Route - Student", () => {
	...
	it("should get user profile", async () => {
		const client = treaty(
			userRoute(mockPrisma, mockCache as any, mockStudentAuth),
		);
		const response = await client.user.me.get();
...
describe("User Route - Unauthenticated", () => {
	...
	it("should reject unauthorized access to /me", async () => {
		const client = treaty(
			userRoute(mockPrisma, mockCache as any, mockOtherAuth),
		);
		const response = await client.user.me.get();
